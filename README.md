...
The `dsm` node is a pure Node.js package and doesn't use any external libraries, there is also no config node. The dsm configuration is set programmatically e.g. using an inject node and can be modified as needed. 
